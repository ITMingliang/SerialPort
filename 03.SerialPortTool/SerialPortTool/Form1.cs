    ...
    public partial class Form1 : Form
    {
        ...
        private void post_DataReceived(object sender, SerialDataReceivedEventArgs e)
        {
            ...
            else
            {
                ...
                string str = Convert.ToString(data, 16).ToUpper();//转为十六进制
                textBox_receive.AppendText("0x" + (str.Length == 1 ? "0" + str : str) + "  ");//拼接成两位
